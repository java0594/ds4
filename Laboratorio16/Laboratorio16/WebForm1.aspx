...
<body>
    <form id="form1" runat="server">
        <div class="cal">
            ...
            <asp:Button ID="b3" Text="3" runat="server" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="b3_Click" />
            <asp:Button ID="add" Text="+" runat="server" Height="37px" Style="margin-left: Opx;
                margin-top: Opx;" Width="57px" OnClick="add_Click" />
            ...
            <asp:Button ID="sub" Text="-" runat="server" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="sub_Click" />
            <asp:Button ID="b7" Text="7" runat="server" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="b7_Click" />
            <asp:Button ID="b8" Text="8" runat="server" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="b8_Click" />
            <asp:Button ID="b9" Text="9" runat="server" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="b9_Click" />
            <asp:Button ID="mul" Text="*" runat="server" Height="37px" Style="margin-left: Opx"
            ...
            <asp:Button ID="clr" runat="server" Text="CLR" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="clr_Click" />
            <asp:Button ID="eql" runat="server" Text="=" Height="37px" Style="margin-left: Opx"
                Width="57px" OnClick="eql_Click" />
            <asp:Button ID="div" Text="/" runat="server" Height="37px" Style="margin-left: Opx"
